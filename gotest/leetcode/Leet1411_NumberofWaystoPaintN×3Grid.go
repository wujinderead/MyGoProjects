...
// exactly one of the three colours: Red, Yellow or Green while making sure that no
// two adjacent cells have the same colour (i.e no two cells that share vertical
...
// for first row, we have 12 solutions, with 6 in ABA mode, 6 in ABC mode.
// for previous row in ABA mode, we have 5 solutions, 3 in ABA, 2 in ABC.
// for previous row in ABC mode, we have 4 solutions, 2 in ABA, 2 in ABC.
