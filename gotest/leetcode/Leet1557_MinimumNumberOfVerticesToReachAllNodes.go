...
func findSmallestSetOfVertices(n int, edges [][]int) []int {
    // find those nods with in-degree 0
	in := make([]int, n)
	for _, v := range edges {
		in[v[1]]++
	}
...
func main() {
	fmt.Println(findSmallestSetOfVertices(6, [][]int{{0,1},{0,2},{2,5},{3,4},{4,2}}), []int{0,3})
	fmt.Println(findSmallestSetOfVertices(5, [][]int{{0,1},{2,1},{3,1},{1,4},{2,4}}), []int{0,2,3})
}