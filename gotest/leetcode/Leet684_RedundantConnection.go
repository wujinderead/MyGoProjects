...
//   is an undirected graph. For the directed graph follow up please see Redundant Connection II).
//   We apologize for any inconvenience caused.

func findRedundantConnection(edges [][]int) []int {
    // use union-find to detect circle in the graph,
	// the first edge makes a circle is what we want.
...
func main() {
	for _, v := range []struct{edges [][]int; ans []int} {
		...
		fmt.Println(findRedundantConnection(v.edges), v.ans)
	}
}