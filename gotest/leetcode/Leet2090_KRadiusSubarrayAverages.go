...
// For example, the average of four elements 2, 3, 1, and 5 is (2 + 3 + 1 + 5) / 4 = 11 / 4 = 3.75,
...
// straightforward solution; could be more concise
...
func main() {
	for _, v := range []struct {
		...
		fmt.Println(getAverages(v.n, v.k), v.ans)
	}
}
