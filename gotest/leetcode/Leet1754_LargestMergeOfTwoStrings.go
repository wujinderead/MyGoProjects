...
// it from word1. For example, if word1 = "abc" and merge = "dv", then after choosing
// this operation, word1 = "bc" and merge = "dva".
//   If word2 is non-empty, append the first character in word2 to merge and delete it
// from word2. For example, if word2 = "abc" and merge = "", then after choosing this
...
func main() {
	for _, v := range []struct {
		...
		fmt.Println(largestMerge(v.w1, v.w2) == v.ans)
	}
}
